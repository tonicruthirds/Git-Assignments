...
//    */
    ...
    let animalArray = [Animal(name: "Rover"), Animal(name: "Mittens"), Animal(name: "Ein"), Animal(name: "Sadie"), ILoveAnimals(name: "Timpleton"), ILoveAnimals(name: "Maggie"), ILoveAnimals(name: "Prissy")]
